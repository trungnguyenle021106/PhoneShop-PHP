                    ...
                    <div class="phone">
                        ...
                        <div class="infor">
                            ...
                            <div class="color_phone">
                                <div style="background-color: rgb(41, 42, 44);
                                display: block;
                                border-radius: 100px;
                    ...
                    <div class="phone">
                        ...
                        <div class="infor">
                            ...
                            <div class="color_phone">
                                ...
                                <div style="background-color: rgb(250, 245, 241);
                                display: block;
                                border-radius: 100px;
                                margin: 0px 5px 5px 0px;
                                width: 10px;
                                ...
                                <div style="background-color: rgb(185, 199, 212);
                                display: block;
                                border-radius: 100px;
                                margin: 0px 5px 5px 0px;
                                width: 10px;
                                ...
                                <div style="background-color: rgb(231, 223, 238);
                                display: block;
                                border-radius: 100px;
                                margin: 0px 5px 5px 0px;
                                width: 10px;
