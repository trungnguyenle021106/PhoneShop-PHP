...
//Dữ liệu toàn cục cho chi tiết phiếu bảo hành
var NGAY_BAT_DAU = ""
var MA_PBH = "";
var MA_KH = "";
var MA_SERIAL = "";
...
//Xử lý giao diện phiếu bảo hành
...
//Xử lý giao diện chi tiết phiếu bảo hành
function BackButton() {
...
function setUICTPBH(data) {
    ...
    var table = document.getElementById("table_PBH");
    table.innerHTML = getUIHeadCTPBH() + getUIContentCTPBH(tenKH, soDT, soSerial, tenSP, TGBH, TINH_TRANG, flag);
    BackButton();
    if (flag == "btn_TL") {
        setBTN_TL();
    }
...
function getUIContentCTPBH(tenKH, SdtKH, soSerial, tenSP, TGBH, TT, flag) {
...
//Xử lý sự kiện nút cho cập nhật trạng thái phiếu bảo hành
function setBTN_TL() {
...
//Xử lý sự kiện nút cho phiếu bảo hành
